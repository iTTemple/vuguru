...
class UIElement_Photo extends UIElement {
	...
	public function getMetaBox() {
		...
		$this->addColorPicker(array(
			...
			'standard' => '',
			'desc' => __('Choose the background color to display at back of this image in a fullsize gallery', MAX_SHORTNAME)
		));		
		...
		$this->addGroupOpen(array(
			...
			$this->addDropdown(array(
				...
				"standard" => "true",
				"desc" => __('Do you want to show a link on the image title in a fullsize gallery?', MAX_SHORTNAME )					
			));			
			...
			$this->addGroupOpen(array(
				...
				$this->addInput(array(
					...
					"size" => "480",
					"desc" => __('You can enter a custom URL to link to when you click on the post title in the Fullsize Gallery view of this post. Leave blank to link to the photo post detail page. Remeber to add a http:// in front of your URL.', MAX_SHORTNAME)
				));		
