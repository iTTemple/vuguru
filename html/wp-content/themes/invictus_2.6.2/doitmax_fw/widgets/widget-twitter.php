	...
	function widget( $args, $instance ) {
		...
		if ( $title )
		 ...
		 ?>
			...
			<script type="text/javascript" src="http://api.twitter.com/1/statuses/user_timeline/<?php echo $user ?>.json?callback=twitterCallback2&amp;count=<?php echo $tweets ?>"></script>
