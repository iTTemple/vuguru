...
/*-----------------------------------------------------------------------------------*/
    ...
    function widget($args, $instance) {
		...
		<li>
			...
			$imgUrl = max_get_custom_image_url(get_post_thumbnail_ID(get_the_ID()), get_the_ID(), $imgDimensions['width'], $imgDimensions['height'] );														
			
			// get the gallery item 
			echo '<a href="' . get_permalink(get_the_ID()) . '" title="' . get_the_ID() . '"><img src="'.$imgUrl.'" width="' . $imgDimensions['width'] . '" height="'. $imgDimensions['height'] . '" alt="' . get_the_title() . '" class="fade-image"/></a>';
			?>
